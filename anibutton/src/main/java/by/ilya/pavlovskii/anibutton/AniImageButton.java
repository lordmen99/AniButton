 ...
 * ===================================================================================
 */
public class AniImageButton extends AppCompatImageButton {

    protected Animator mInAnimator;
    protected Animator mOutAnimator;
    private boolean mPressed;

    public AniImageButton(Context context) {
        super(context);
        init( context, null, 0 );
    }

    public AniImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init( context, attrs, 0 );
    }

    public AniImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.AniImageButton, defStyleAttr, 0);
            int animInRes = typedArray.getResourceId(R.styleable.AniImageButton_anim_in, 0);
            int animOutRes = typedArray.getResourceId(R.styleable.AniImageButton_anim_out, 0);
